...
MODELB_PATH = "./models/model_hff_b.checkpoint"
if __name__ == "__main__":

    t = Genomic2DFeatures(
        ["../resources/4DNFI643OYP9.rebinned.mcool::/resolutions/32000"],
        ["r32000"],
        (8000, 8000),
        cg=True,
    )
    sampler = RandomPositionsSamplerHiC(
        ...
        background_cis_file="../resources/4DNFI643OYP9.rebinned.mcool.expected.res32000.mono.npy",
        background_trans_file="../resources/4DNFI643OYP9.rebinned.mcool.expected.res32000.trans.npy",
    )

    sampler.mode = "train"
    dataloader = SamplerDataLoader(sampler, num_workers=10, batch_size=1, seed=seed)
